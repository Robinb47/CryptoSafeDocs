...
const ScIntegration = () => {
	...
	let contractAddress = '0xaB08867664a17d14B1b8845981561e4783c31646';
	...
	const updateEthers = async () => {
        ...
        //let tempProvider = ethers.getDefaultProvider();
        let tempProvider = new ethers.BrowserProvider(window.ethereum)
		setProvider(tempProvider);

        //wie const wallet = new ethers.Wallet(privateKey, provider);
